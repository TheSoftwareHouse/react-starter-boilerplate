    ...
    return (
        <>
            ...
            <ul>
                ...
                <li><a href="https://github.com/formatjs/react-intl">React Intl</a> - React components and an API to format dates, numbers, and strings, including pluralization and handling translations</li>
            </ul>
            <hr />
            <LocationInfo />
        </>
