...
export const Help: React.FC = () => {
    return (
        <>
            <h2>Help</h2>
            <p>This project was bootstrapped with <a href="https://github.com/facebook/create-react-app">Create React App</a> and modified by TSH team.</p>
            ...
            <h4 id="-npm-run-eject-"><code>npm run eject</code></h4>
